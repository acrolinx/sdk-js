...
function isSsoSigninOption(
  signinOptions: SigninOptions
): signinOptions is SsoSigninOption {
...
export interface CancelablePollLoopOptions
  extends CheckAndGetResultOptions,
...
export class AcrolinxEndpoint {
  ...
  public async singInInteractive(
    opts: SignInInteractiveOptions
    ...
    return this.pollForInteractiveSignIn(
      signinResult,
  ...
  public async signin(options: SigninOptions = {}): Promise<SigninResult> {
    return this.post<SigninResult>(
      ...
      {},
      getSigninRequestHeaders(options)
    );
  }
  ...
  public async validateAppAccessToken(
    appToken: AppAccessToken
  ): Promise<AppAccessTokenValidationResult> {
    return getData(
      this.getJsonFromPath(VALIDATE_APP_ACCESS_TOKEN_PATH, appToken)
    );
  }
  ...
  public getCheckingCapabilities(
    accessToken: AccessToken
  ): Promise<CheckingCapabilities> {
    return getData(
      this.getJsonFromPath("/api/v1/checking/capabilities", accessToken)
    );
  }
  ...
  public async getLiveSuggestions(
    accessToken: AccessToken,
  ...
  public checkAndGetResult(
    ...
    return this.startCancelablePollLoop(
      accessToken,
  ...
  public analyzeAndPoll(
    ...
    return this.startCancelablePollLoop(
      accessToken,
      asyncStartedProcessPromise,
      { ...opts, headers }
    );
  }

  public async cancelCheck(
    accessToken: AccessToken,
    check: CheckResponse
  ): Promise<CancelCheckResponse> {
    return this.cancelAsyncStartedProcess(accessToken, check);
  }

  public async pollForCheckResult(
    accessToken: AccessToken,
    check: CheckResponse
  ...
  public async getTermHarvestingReport(
    ...
    return getData(
      this.getJsonFromUrl<ApiResponse<TermHarvestingReport>>(
        reports.termHarvesting.link,
        accessToken
      )
    );
  }
  ...
  public async getServerNotifications(
    ...
    return this.getJsonFromPath<any>(
      "/api/v1/broadcasts/platform-notifications/" + sinceTimeStamp,
      accessToken
    );
  }
  ...
  public getDictionaryCapabilities(
    accessToken: AccessToken
  ): Promise<DictionaryCapabilities> {
    return getData(
      this.getJsonFromPath("/api/v1/dictionary/capabilities", accessToken)
    );
  }

  public addToDictionary(
    accessToken: AccessToken,
    req: AddToDictionaryRequest
  ): Promise<AddToDictionaryResponse> {
    return getData(
      this.post("/api/v1/dictionary/submit", req, {}, accessToken)
    );
  }
  ...
  public setUserCustomFields(
    ...
    return getData(
      this.put("/api/v1/user/" + id, requestBody, {}, accessToken)
    );
  }

  public getDocumentDescriptor(
    accessToken: AccessToken,
    id: DocumentId
  ): Promise<DocumentDescriptor> {
    return getData<DocumentDescriptor>(
      this.getJsonFromPath("/api/v1/document/" + id, accessToken)
  ...
  public setDocumentCustomFields(
    ...
    return getData(
      this.put("/api/v1/document/" + documentId, requestBody, {}, accessToken)
    );
  }
  ...
  private async pollForInteractiveSignIn(
    ...
    throw new AcrolinxError({
      ...
      detail: `Interactive sign-in has timed out by client (${
        Date.now() - startTime
      } > ${timeoutMs} ms).`,
    });
  }
  ...
  private async cancelAsyncStartedProcess<CancelResponse>(
    ...
    return this.deleteUrl<CancelResponse>(
      process.links.cancel,
      accessToken,
      opts
    );
  }
