...
describe('Sign In With Device Grant', () => {
  ...
  it('should get single tenant access token from keycloak token', async () => {
    ...
    const acrolinxEndpint = new AcrolinxEndpoint({
      ...
      additionalHeaders: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJSb2xlIjoiQWRtaW4iLCJJc3N1ZXIiOiJJc3N1ZXIiLCJVc2VybmFtZSI6ImV4YW1wbGUiLCJwcmVmZXJyZWRfdXNlcm5hbWUiOiJleGFtcGxlIiwiZXhwIjoxNzEwNDk5MDQ0LCJpYXQiOjE3MTA0OTkwNDQsImdlbmVyaWNQYXNzd29yZCI6InBhc3N3b3JkIn0.WqZWigl6XCpEryU94dvnFaq2Nepovl0pTWAofMltOd0',
      },
    });
